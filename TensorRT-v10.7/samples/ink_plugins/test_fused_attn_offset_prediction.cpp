/*
First successful implementation of fused_attn_offset_prediction plugin.

NOTE:
1. Plugin attributes are allocated to GPU memory in fused_attn_offset_prediction::onShapeChange.
We do not perform allocation in fused_attn_offset_prediction::configurePlugin since this function does
not get executed in runtime.
We would try other allocation locations in future implementations.
